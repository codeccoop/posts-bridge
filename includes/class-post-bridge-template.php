...
class Post_Bridge_Template
{
    ...
    public static function schema($addon = null)
    {
        ...
        $schema = [
            ...
            'required' => ['name', 'title', 'fields', 'backend', 'bridge'],
        ];
    ...
    private function create_backend($data)
    {
        ...
        do_action_ref_array('posts_bridge_before_template_backend', [
            $data,
            $this->name,
            $this,
        ]);
    ...
    private function create_bridge($data)
    {
        ...
        do_action_ref_array('posts_bridge_before_template_bridge', [
            $data,
            $this->name,
            $this,
        ]);
    ...
    private function create_credential($data)
    {
        ...
        do_action_ref_array('posts_bridge_before_template_credential', [
            $data,
            $this->name,
            $this,
        ]);
