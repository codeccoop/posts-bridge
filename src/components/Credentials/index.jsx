...
export default function Credentials({ credentials, setCredentials }) {
    ...
    .concat([
      {
        index: -1,
        name: "new",
        title: __("Add a credential", "posts-bridge"),
        icon: (
  ...
  return (
    <PanelBody title={__("Authentication", "posts-bridge")} initialOpen={false}>
      <div style={{ width: "100%" }}>
        <p>{__("HTTP authentication credentials", "posts-bridge")}</p>
